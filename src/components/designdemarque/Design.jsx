      ...
      <>
        ...
        <div className="container-fluid bgcolor_purple cf2_design" >
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col_for_img">
              <img src="imagesAnima/devweb/1.png" className='img_section1_devweb' alt="" data-aos="zoom-in-right" data-aos-duration="1500" />
            </div>
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 ">
              <h1 className="h1_section1_devweb" data-aos="flip-left" data-aos-duration="1500">
                UI & uX
              </h1>
              <p className="p_section1_devweb" data-aos="fade-up" data-aos-duration="1500">
        ...
        <div className="container-fluid section2_devweb bgcolor_purple">
          <div className="content_section2_devweb">
            <h1 className="h1_section2_devweb" data-aos="flip-left" data-aos-duration="1500">
              Quelles sont les étapes du design
              de marque
            </h1>
            <p className="p_section2_devweb p_section2_design" data-aos="zoom-in-left" data-aos-duration="1500">
        ...
        <div className="container-fluid section2_devweb bgcolor_purple">
          <div className="content_section2_devweb">
            <h1 className="h1_section2_devweb h1_section2_outils" data-aos="fade-down-left" data-aos-duration="1500">
              Outils et technologies
            </h1>
            <p className="p_section2_devweb p_section2_outils" data-aos="fade-up-right" data-aos-duration="1500">
              Figma, Adobe XD,
            </p>
          </div>
        </div>
