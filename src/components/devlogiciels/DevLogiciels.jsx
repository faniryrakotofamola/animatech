      ...
      <>
        ...
        <div className="container-fluid banner_devweb banner_devlogiciel">
          <div className="content_devweb">
            <h1 className="h1_banner_devweb" data-aos="flip-up" data-aos-duration="1500" data-aos-offset="100">
              Développement <span className='span_h1_banner_devweb'>de logiciels</span>
            </h1>
            <p className="p_banner_devweb" data-aos="fade-down" data-aos-duration="1500" data-aos-offset="200">
        ...
        <div className="container-fluid section2_devweb bgcolor_purple">
          <div className="content_section2_devweb">
            <h1 className="h1_section2_devweb" data-aos="zoom-out-up" data-aos-duration="1500" data-aos-offset="150">
              Avantage de Logiciel Sur Mesure
            </h1>
            <p className="p_section2_devweb p_section2_logiciels" data-aos="zoom-in-up" data-aos-duration="1500" data-aos-offset="150">
          ...
          <div className="section3">
            <div className="row row1_section3 row1_section3_devlogiciel" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="100">
            ...
            <div className="row row1_section3 row2_section3 row1_section3_devlogiciel" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="100">
