          ...
          <div className="container-fluid">
            <div className="row pt-5 pb-5">
              <div className="col-lg-6 col-xl-6 col-md-12 col-sm-12 col1_section1">
                <div className="">
                  <img src="imagesAnima/devmobile/1.png" className='img_section1' alt="imagesection1" data-aos="zoom-in-right" data-aos-duration="1500" data-aos-offset="50" />
                </div>
              </div>
              <div className="col-lg-6 col-lg-6 col-xl-6 col-sm-12 col-md-12">
                <h2 className='h2_section1' data-aos="zoom-in-left" data-aos-duration="1500" data-aos-offset="100">Développement mobile</h2>
                <p className="p_section1" data-aos="zoom-out-left" data-aos-duration="1500" data-aos-offset="100">
          ...
          <div className="container-fluid cf_devmob">
            <div className="row row1">
              <div className="col-lg-8 col-lx-8 col-md-12 col1_section2">
                <p className='p_section2' data-aos="fade-right" data-aos-duration="1500" >
              ...
              <div className="col-lg-4 col-xl-4 col-md-12 col-sm-12 col2_section2">
                <img src="imagesAnima/devmobile/2.png" className='img1_section2' alt="" data-aos="zoom-in" data-aos-duration="1500" data-aos-offset="50" />
              </div>
            </div>
          </div>
          <div className="container-fluid cf_devmob">
            <div className="row ">
              <div className="col-lg-4 col2_section2">
                <img src="imagesAnima/devmobile/3.png" className='img1_section2 img2_section2' alt="" data-aos="zoom-in" data-aos-duration="1500" data-aos-offset="100" />
              </div>
              <div className="col-lg-8 col1_section2">
                <p className='p_section2' data-aos="fade-left" data-aos-duration="1500" data-aos-offset="100">
