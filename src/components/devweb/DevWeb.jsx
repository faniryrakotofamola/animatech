      ...
      <>
        ...
        <div className="container-fluid banner_devweb" >
          <div className="content_devweb">
            <h1 className="h1_banner_devweb" data-aos="zoom-out-up" data-aos-duration="1500" data-aos-offset="200">
              Développement <br /><span className='span_h1_banner_devweb'>web</span>
            </h1>
            <p className="p_banner_devweb" data-aos="zoom-in-up" data-aos-duration="1500" data-aos-offset="100">
        ...
        <div className="container-fluid bgcolor_purple cf2_devweb">
          <div className="row row0_devweb">
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col_for_img" data-aos="fade-up-right" data-aos-duration="1500" data-aos-offset="100">
              <img src="imagesAnima/devweb/1.png" className='img_section1_devweb' alt="" />
            </div>
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 ">
              <h1 className="h1_section1_devweb" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="100">
                Développement web sur mesure
              </h1>
              <p className="p_section1_devweb" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="100">
        ...
        <div className="container-fluid section2_devweb bgcolor_purple">
          <div className="content_section2_devweb">
            <h1 className="h1_section2_devweb" data-aos="zoom-in-right" data-aos-duration="1500" data-aos-offset="100">
              Quelles sont les étapes du développement
              d'une application web?
            </h1>
            <p className="p_section2_devweb" data-aos="zoom-in-left" data-aos-duration="1500" data-aos-offset="100">
          ...
          <div className="section3" >
            <div className="row row0_devweb row1_section3" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="100">
            ...
            <div className="row row0_devweb row1_section3 row2_section3" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="100">
